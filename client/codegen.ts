    ...
    "./src/graphql-codegen/": {
      ...
      config: {
        ...
        scalars: {
          ...
          BackupPolicyGroupBy: "PrismaJson.BackupPolicyGroupBy",
          BackupDestinationGroupBy: "PrismaJson.BackupDestinationGroupBy",
          BackupRunGroupBy: "PrismaJson.BackupRunGroupBy",
          BackupKeyGroupBy: "PrismaJson.BackupKeyGroupBy",
        },
      },
    },
  },
