...
export type Scalars = {
  ...
  FeedbackStatus: { Input: FeedbackStatus; Output: FeedbackStatus };
  Mode: { Input: Mode; Output: Mode };
  Mutation: { Input: Mutation; Output: Mutation };
...
export type GroupByInput<T extends { _avg?: any; _count?: any; _max?: any; _min?: any; _sum?: any }> = Pick<
  Partial<T>,
  "_avg" | "_count" | "_max" | "_min" | "_sum"
> & { _count?: object };
