...
export class FeedbackQuery {
  ...
  constructor(
    ...
    builder.queryField("pageFeedback", (t) =>
      t.prismaConnection({
    ...
    builder.queryField("readFeedbacks", (t) =>
      t.prismaField({
    ...
    builder.queryField("countFeedbacks", (t) =>
      t.field({
    ...
    builder.queryField("groupFeedbacks", (t) =>
      t.field({
