...
let AuthController = AuthController_1 = class AuthController {
    ...
    provider(provider) {
        ...
        return (0, lodash_1.pick)(info, ["name", "label", "credentials"]);
    }
    async logout(req) {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ schema: { type: "array", items: { type: "string" } } }),
    (0, common_1.Get)(),
...
__decorate([
    (0, swagger_1.ApiTags)("auth", "provider"),
    (0, common_1.Get)(":provider"),
    __param(0, (0, common_1.Param)("provider")),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], AuthController.prototype, "provider", null);
__decorate([
