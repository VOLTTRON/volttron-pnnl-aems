    ...
    constructor(builder, prismaService, scheduleObject) {
        ...
        this.ScheduleWhere = builder.prismaWhere("Schedule", {
            fields: {
                ...
                override: BooleanFilter,
                overridePreStartTime: StringFilter,
                overridePreEndTime: StringFilter,
                overridePostStartTime: StringFilter,
                overridePostEndTime: StringFilter,
