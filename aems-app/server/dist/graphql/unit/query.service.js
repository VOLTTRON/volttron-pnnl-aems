...
let UnitQuery = class UnitQuery {
    constructor(builder, prismaService, unitObject) {
        ...
        this.UnitWhere = builder.prismaWhere("Unit", {
            fields: {
                ...
                occupancyDetection: BooleanFilter,
        ...
        builder.addScalarType("UnitGroupBy", new graphql_1.GraphQLScalarType({
            name: "UnitGroupBy",
        }));
        const { UnitWhere, UnitWhereUnique, UnitOrderBy, UnitAggregate } = this;
        builder.queryField("pageUnit", (t) => t.prismaConnection({
        ...
        builder.queryField("readUnit", (t) => t.prismaField({
        ...
        builder.queryField("readUnits", (t) => t.prismaField({
        ...
        builder.queryField("countUnits", (t) => t.field({
        ...
        builder.queryField("groupUnits", (t) => t.field({
...
exports.UnitQuery = UnitQuery = __decorate([
    (0, common_1.Injectable)(),
    (0, pothos_decorator_1.PothosQuery)(),
    __metadata("design:paramtypes", [builder_service_1.SchemaBuilderService, prisma_service_1.PrismaService, object_service_1.UnitObject])
], UnitQuery);
