...
export class Tree<T extends { [key in C["id" | "parentId"]]: string | number | undefined }, C extends ConfigType<T>> {
...
export function buildTree<
  T extends { [key in C["id" | "parentId"]]: string | number | undefined },
