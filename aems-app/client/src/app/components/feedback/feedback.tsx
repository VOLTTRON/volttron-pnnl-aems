...
import { FeedbackStatus, RoleType } from "@local/common";
...
async function uploadFiles(files: File[]) {
  ...
  const response = await fetch(`${process.env.NEXT_PUBLIC_HTTP_API || "/api"}/file/upload`, {
    method: "POST",
    body: formData,
  });
