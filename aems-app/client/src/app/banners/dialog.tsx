...
export function CreateBanner({
  ...
  useEffect(() => {
    setError("");
    setMessage("");
    setExpiration(new Date(new Date().getTime() + 1 * 60 * 60 * 1000).toISOString());
  }, [open]);
...
export function UpdateBanner({
  ...
  useEffect(() => {
    ...
    setExpiration(banner?.expiration ?? new Date().toISOString());
              ...
              await updateBanner({
                variables: {
                  ...
                  update: {
                    ...
                    ...(expiration !== banner?.expiration && { expiration: expiration }),
                  },
                },
              })
                .then(() => {
