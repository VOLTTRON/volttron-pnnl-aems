import { File as _File, ReadFeedbackFilesQuery } from "@/generated/graphql-codegen/graphql";
import { Button, Dialog, Icon } from "@blueprintjs/core";
import styles from "./page.module.scss";
import { useState } from "react";
import Image from "next/image";

export function FilePreview({ file }: { file: NonNullable<ReadFeedbackFilesQuery["readFeedbackFiles"]>[0] }) {
...
export function FilePreviews({ files }: { files: ReadFeedbackFilesQuery["readFeedbackFiles"] }) {
